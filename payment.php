    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            payButton.addEventListener('click', () => {
                if (paymentMethod.value === 'cash') {
                    window.location.href = 'http://localhost/WebApplication1/thankyou.php'; // Redirect for Cash on Delivery
                } else if (paymentMethod.value === 'upi') {
                    window.location.href = 'http://localhost/WebApplication1/thankyou.php';  // Redirect for UPI payment process
                } else if (paymentMethod.value === 'card') {
                    window.location.href = 'http://localhost/WebApplication1/thankyou.php'; // Redirect for Credit Card payment
                }
            });

            backButton.addEventListener('click', () => {
                window.location.href = 'http://localhost/order.php'; // Redirect to menu page
            });
        });
    </script>
</body>
